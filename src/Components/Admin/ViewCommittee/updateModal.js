...
export const Modalupdate = ({ show, close, committeeDetails, memberDetails, headDetails}) => {
  const [CommitteeName, setName]= useState(committeeDetails.CommitteeName);
    ...
    const [CommitteeHead, setHead]= useState(headDetails.idUser);
    ...
    const CreateCommittee = async () => {
        ...
        try {
            var res = await axios({
                method: 'put',
                url: 'http://localhost:3306/viewCommitteesADMIN/updateCommittee',
                data: {
    ...
    <h4 className="modal-title align-center">Committee : </h4>
                ...
                <div className="col-lg-12">
                    ...
                    <div className="col-md-10">
                        <Select placeholder={headDetails.Name} options={selectedOption} onChange={(e) => setHead(e.value)} />
                    </div>
                    </div>
                </div>
                <div className="row">
